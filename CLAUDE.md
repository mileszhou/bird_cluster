...
`docs/plans/2026-07-29-embed-cluster-stats.md`.
...
A full survey of the current dataset is in `docs/reports/01-data_preview_report.md`,
regenerated by `tools/audit_dataset.py` (read-only, ~15s).
