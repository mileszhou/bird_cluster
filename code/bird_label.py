...
#   raw/Photos-23.01.xmp/2023-04-10 Old Town/_Z9C7446.xmp
...
if __name__ == "__main__":
    ...
    parser.add_argument("--vllm-url", default="http://localhost:8000/v1", help="URL for the vLLM OpenAI-compatible server (vllm approach only)")
