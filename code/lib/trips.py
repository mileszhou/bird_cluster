...
# "2023-10-05 Blue Lake", "2020-11 Rivercity.鸟". "0000-test" is a scratch folder.
...
def trip_date(folder_name: str) -> Optional[date]:
    ...
    Day-less names (`2020-11 Rivercity.鸟`) are treated as the 1st, which is precise
...
class Trip(NamedTuple):
    name: str            # folder name, e.g. "2023-10-05 Blue Lake"
