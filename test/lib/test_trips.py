...
@pytest.mark.parametrize("name,expected", [
    ("2023-10-05 Blue Lake", date(2023, 10, 5)),
    ("2020-11 Rivercity.鸟", date(2020, 11, 1)),        # day-less: 1st is precise enough to order
    ("2019-02-08 Riverton2、7、8、10、5Pond", date(2019, 2, 8)),
    ("0000-test", None),
    ("no date here", None),
...
@pytest.mark.parametrize("name,expected", [
    ("2023-10-05 Blue Lake", "day"),
    ("2020-11 Rivercity.鸟", "month"),      # names a whole month, not its 1st
    ("no date here", None),
])
