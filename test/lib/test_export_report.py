...
REPORT = """This file is a video. (2)
    D:\\Lightroom\\MediaFiles\\Photos\\Photos-20\\2020-10-02 Bayside\\clip.mp4
    D:\\Lightroom\\MediaFiles\\Photos\\Photos-25\\2025-06-01 Village\\IMG_1145.mp4
The file could not be found. (3)
    D:\\Lightroom\\MediaFiles\\Photos\\Photos-19\\2019-06-08 Hill Park\\_D5V0824.nef
...
def test_windows_paths_are_reanchored_at_the_library(report):
    assert report.reason_for("Photos-19/2019-06-08 Hill Park", "_D5V0824") == NOT_FOUND
...
def test_unlisted_photo_has_no_reason(report):
    assert report.reason_for("Photos-19/2019-06-08 Hill Park", "_D5V9999") is None
